...
class ShopCart(models.Model):
    ...
    def countproduct(self):
        count = ShopCart.objects.filter(product=self).aggregate(count=Count('id'))
        cnt = 0
...
class Order(models.Model):
    ...
    extra_note = models.CharField(max_length=255)
...
class OrderForm(ModelForm):
    class Meta:
        model = Order
        fields = ['first_name','last_name','address','phone','city','country','delivery_time','extra_note']
